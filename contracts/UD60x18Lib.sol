...
abstract contract UD60x18Lib {
    ...
    function ud(uint256 x) public pure returns (UD60x18) {
        return UD60x18.wrap(x);
    }

    function unwrap(UD60x18 x) public pure returns (uint256) {
        return UD60x18.unwrap(x);
    }

    function ud_add(UD60x18 x, UD60x18 y) public pure returns (UD60x18) {
        return UD60x18.wrap(UD60x18.unwrap(x) + UD60x18.unwrap(y));
    }

    function ud_sub(UD60x18 x, UD60x18 y) public pure returns (UD60x18) {
        return UD60x18.wrap(UD60x18.unwrap(x) - UD60x18.unwrap(y));
    }

    function ud_mul(UD60x18 x, UD60x18 y) public pure returns (UD60x18) {
        return UD60x18.wrap((UD60x18.unwrap(x) * UD60x18.unwrap(y)) / 1e18);
    }

    function ud_div(UD60x18 x, UD60x18 y) public pure returns (UD60x18) {
        return UD60x18.wrap((UD60x18.unwrap(x) * 1e18) / UD60x18.unwrap(y));
    }

    function ud_sqrt(UD60x18 x) public pure returns (UD60x18) {
